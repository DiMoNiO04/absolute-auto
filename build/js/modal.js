...
var modalUpdatePassword = document.querySelector('[data-modal="update-password"]') ? new Modal('update-password') : null;
var modalUpdateAddress = document.querySelector('[data-modal="update-address"]') ? new Modal('update-address') : null;
var modalUpdateNameAuto = document.querySelector('[data-modal="update-name-auto"]') ? new Modal('update-name-auto') : null;
var modalPurchaseReturns = document.querySelector('[data-modal="purchase-returns"]') ? new Modal('purchase-returns') : null;
