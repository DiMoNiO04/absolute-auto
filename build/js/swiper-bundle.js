...
(function (global, factory) {
  ...
  function updateSlides() {
    ...
    if (params.setWrapperSize) {
      $wrapperEl.css(
        _defineProperty({}, getDirectionLabel('width'), ''.concat(swiper.virtualSize + params.spaceBetween, 'px'))
      );
    }
    if (gridEnabled) {
  ...
  function updateSlidesClasses() {
    ...
    if (isVirtual) {
      activeSlide = swiper.$wrapperEl.find(
        '.'.concat(params.slideClass, '[data-swiper-slide-index="').concat(activeIndex, '"]')
      );
    } else {
  ...
  function translateTo(translate, speed, runCallbacks, translateBounds, internal) {
    ...
    if (params.cssMode) {
      ...
      if (speed === 0) {
        ...
        wrapperEl.scrollTo(
          ((_wrapperEl$scrollTo = {}),
          _defineProperty(_wrapperEl$scrollTo, isH ? 'left' : 'top', -newTranslate),
  ...
  function slideTo(index, speed, runCallbacks, internal, initial) {
    ...
    if (typeof index !== 'number' && typeof index !== 'string') {
      throw new Error(
        "The 'index' argument cannot have type other than 'number' or 'string'. [".concat(_typeof(index), '] given.')
      );
    }
    if (typeof index === 'string') {
      ...
      if (!isValidNumber) {
        throw new Error(
          "The passed-in 'index' (string) couldn't be converted to 'number'. [".concat(index, '] given.')
        );
    ...
    if (params.cssMode) {
      ...
      if (speed === 0) {
        ...
        wrapperEl.scrollTo(
          ...
          _defineProperty(_wrapperEl$scrollTo2, isH ? 'left' : 'top', t),
  ...
  function setBreakpoint() {
    ...
    if (wasMultiRow && !isMultiRow) {
      $el.removeClass(
        ''.concat(params.containerModifierClass, 'grid ').concat(params.containerModifierClass, 'grid-column')
      );
              ...
              if (view === 'current') {
                for (var _i5 = activeIndex + 1; _i5 < slides.length; _i5 += 1) {
                  var slideInView = exact
                    ? slidesGrid[_i5] + slidesSizesGrid[_i5] - slidesGrid[activeIndex] < swiperSize
                    : slidesGrid[_i5] - slidesGrid[activeIndex] < swiperSize;
                  if (slideInView) {
                    spv += 1;
                  }
                }
    ...
    function update(force) {
      ...
      if (force) {
        ...
        for (var i = previousFrom; i <= previousTo; i += 1) {
          if (i < from || i > to) {
            swiper.$wrapperEl
              .find('.'.concat(swiper.params.slideClass, '[data-swiper-slide-index="').concat(i, '"]'))
              .remove();
          }
        }
      }
    ...
    function handle(event) {
      ...
      if (
        ...
        if (
          ...
          swiper.$el.parents('.'.concat(swiper.params.slideActiveClass)).length === 0
        ) {
          return undefined;
        }
        var $el = swiper.$el;
  ...
  function Pagination(_ref) {
    ...
    function setSideBullets($bulletEl, position) {
      ...
      $bulletEl[position]()
        ...
        [position]()
        .addClass(''.concat(bulletActiveClass, '-').concat(position, '-').concat(position));
    }
    function update() {
      ...
      if (params.type === 'progressbar') {
        ...
        $el
          ...
          .transform('translate3d(0,0,0) scaleX('.concat(scaleX, ') scaleY(').concat(scaleY, ')'))
  ...
  function Zoom(_ref) {
    ...
    function onTouchEnd() {
      ...
      gesture.$imageWrapEl
        ...
        .transform('translate3d('.concat(image.currentX, 'px, ').concat(image.currentY, 'px,0)'));
    }
  ...
  function Lazy(_ref) {
    ...
    function loadInSlide(index, loadInDuplicate) {
      ...
      var $slideEl = isVirtual
        ? swiper.$wrapperEl.children(
            '.'.concat(swiper.params.slideClass, '[data-swiper-slide-index="').concat(index, '"]')
          )
        : swiper.slides.eq(index);
      var $images = $slideEl.find(
        '.'.concat(params.elementClass, ':not(.').concat(params.loadedClass, '):not(.').concat(params.loadingClass, ')')
      );
      if (
          ...
          if (swiper.params.loop && loadInDuplicate) {
            ...
            if ($slideEl.hasClass(swiper.params.slideDuplicateClass)) {
              ...
              var duplicatedSlide = swiper.$wrapperEl.children(
                '.'
                  .concat(swiper.params.slideDuplicateClass, '[data-swiper-slide-index="')
    ...
    function load() {
      ...
      function slideExist(index) {
        if (isVirtual) {
          if (
            $wrapperEl.children('.'.concat(swiperParams.slideClass, '[data-swiper-slide-index="').concat(index, '"]'))
              .length
          ) {
            return true;
          }
    ...
    var onHashChange = function onHashChange() {
      ...
      if (newHash !== activeSlideHash) {
        var newIndex = swiper.$wrapperEl
          .children('.'.concat(swiper.params.slideClass, '[data-hash="').concat(newHash, '"]'))
          .index();
  ...
  function Thumb(_ref) {
    ...
    function init() {
      ...
      if (thumbsParams.swiper instanceof SwiperClass) {
        ...
        var thumbsSwiperParams = _objectSpread({}, thumbsParams.swiper);
  ...
  function Grid(_ref) {
    ...
    var updateWrapperSize = function updateWrapperSize(slideSize, snapGrid, getDirectionLabel) {
      ...
      swiper.$wrapperEl.css(
        _defineProperty({}, getDirectionLabel('width'), ''.concat(swiper.virtualSize + spaceBetween, 'px'))
      );
      if (centeredSlides) {
        ...
        if (isHorizontal) {
          $cubeShadowEl.transform(
            'translate3d(0px, '
              ...
              .concat(-swiperWidth / 2, 'px) rotateX(90deg) rotateZ(0deg) scale(')
  ...
  function EffectCreative(_ref) {
    ...
    var setTranslate = function setTranslate() {
      ...
      var _loop = function _loop() {
        ...
        var scaleString =
          originalProgress < 0
            ? 'scale('.concat(1 + (1 - data.scale) * originalProgress * multiplier, ')')
            : 'scale('.concat(1 - (1 - data.scale) * originalProgress * multiplier, ')');
        var opacityString =
          originalProgress < 0
