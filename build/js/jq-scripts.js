...
$('.main-main__search-form-select').on('click', function () {
  ...
  $(this).find('.main-main__search-form-select-input').on('input', function () {
...
$('.main-main__search-form-select').find('button').each(function () {
...
$('.main-main__search-form-btn-reset').on('click', function () {
  $('.main-main__search-form-select').each(function () {
